/*
 * No c ler o vetor e criar um novo pegando de 5 em 5
 * dpois criar uma funcao no arduino que leia um byte e copie ele 4x, assim recuperamos os som e nao perdemos muita a qualidade
*/
